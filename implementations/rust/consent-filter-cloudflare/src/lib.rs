...
///   - `x-bench-origin` header present: Pass/Strip fetch the ORIGIN_URL
...
/// Re-issue the request against ORIGIN_URL with tracking headers removed and
/// the Cookie header replaced by its cleaned form.
